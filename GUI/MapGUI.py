...
class MapGUI:
    ...
    def bindCanvas(self):
        ...
        self.canvas.bind("<Button-4>", self.handleMouseWheel)
        self.canvas.bind("<Button-5>", self.handleMouseWheel)
    ...
    def createButton(self, mainFrame):
        ...
        self.epsilonLabel.grid(row=row, column=51, rowspan=3, columnspan=2)

        row+=2
        self.pathCountLabel = Label(mainFrame, text='Path: ' + str(self.pathCount), fg="red", font="20")
        self.pathCountLabel.grid(row=row, column=51, rowspan=3, columnspan=2)
    ...
    def setEpsilon(self, epsilon):
        ...
        self.epsilonLabel['text'] = 'Epsilon: ' + str(self.epsilon)

    def setPathCount(self, pathCount):
        self.pathCount = pathCount
        self.pathCountLabel['text'] = 'Path: ' + str(self.pathCount)
